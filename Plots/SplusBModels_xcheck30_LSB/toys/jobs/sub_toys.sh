...
#Generate command
combine /afs/cern.ch/work/p/prsaha/public/FinalFit_lite/CMSSW_10_2_13/src/flashggFinalFit/Plots/../Combine/higgsCombineTest.MultiDimFit.mH125.root -m 125.000 -M GenerateOnly --saveWorkspace -t 500 --setParameters r=1.67 -s -1 -n _${itoy}_gen_step --snapshotName MultiDimFit --floatAllNuisances 1 --toysFrequentist
