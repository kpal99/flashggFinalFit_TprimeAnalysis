...
ulimit -s unlimited
set -e
cd /afs/cern.ch/work/p/prsaha/public/FinalFit_lite/CMSSW_10_2_13/src/flashggFinalFit/Plots/SplusBModels_Tprime700_Had/toys
...
#Generate command
combine /afs/cern.ch/work/p/prsaha/public/FinalFit_lite/CMSSW_10_2_13/src/flashggFinalFit/Plots/../Combine/result_UL_v2/Models_Tprime700_Had/higgsCombine_Had_Syst.MultiDimFit.mH125.root -m 125.000 -M GenerateOnly --saveWorkspace --toysFrequentist --bypassFrequentistFit -t 500 --setParameters r=1.000 -s -1 -n _${itoy}_gen_step --snapshotName MultiDimFit
