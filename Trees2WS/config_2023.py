...
trees2wsCfg = {
  ...
  'mainVars':["CMS_hgg_mass","weight","weight_central","dZ","*Up", "*Down"], # Vars to add to nominal RooDatasets
  ...
  'systematics':['ElectronScale', 'ElectronSmearing', 'FNUF', 'JecSystTotal', 'JerSyst', 'Material', 'MuonResolution', 'MuonScale', 'PhotonIDMVAShape', 'ScaleZee', 'ScaleZmmg', 'Smearing'],
