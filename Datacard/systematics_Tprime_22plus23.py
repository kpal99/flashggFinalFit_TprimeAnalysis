...
experimental_systematics = [
                {'name':'lumi_13p6TeV_Correlated','title':'lumi_13p6TeV_Correlated','type':'constant','prior':'lnN','correlateAcrossYears':1,'value': '1.014'},
...
signal_shape_systematics = [
                ...
                {'name': 'ScaleZee', 'title': 'ScaleZee', 'type': 'signal_shape', 'mode': 'scales', 'mean': '0.0', 'sigma': '1.0'},
                {'name': 'ScaleZmmg', 'title': 'ScaleZmmg', 'type': 'signal_shape', 'mode': 'scales', 'mean': '0.0', 'sigma': '1.0'},
