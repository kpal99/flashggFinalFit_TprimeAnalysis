        ...
        if $RUNSCRIPTS; then
            ...
            if $CATEGORY; then
                ...
                do
                    ...
                    echo cp -v yields_TprimeM"$m"Decay"$d"pctSch/$cat.pkl yields_TprimeM"$m"Decay"$d"pctSch_$cat
                    ...
                    if $RUN; then
                        ...
                        cp -v yields_TprimeM"$m"Decay"$d"pctSch/$cat.pkl yields_TprimeM"$m"Decay"$d"pctSch_$cat
