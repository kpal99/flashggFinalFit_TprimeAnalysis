...
cd $(dirname $0)
echo python3 make_config.py --inputWSDir $INPUTDIR/$TPRIMEPROC/ws --procs ${TPRIMEPROC}_${YEAR} --year 2017
...
if $RUN; then
    python3 make_config.py --inputWSDir $INPUTDIR/$TPRIMEPROC/ws --procs ${TPRIMEPROC}_${YEAR} --year 2017
