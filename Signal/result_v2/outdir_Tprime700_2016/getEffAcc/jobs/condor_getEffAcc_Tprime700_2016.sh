...
python /afs/cern.ch/work/p/prsaha/public/FinalFit_lite/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/getEffAcc.py --inputWSDir /eos/user/p/prsaha/Tprime_analysis/FinalFit_inputs/v2/2016/M700 --ext Tprime700_2016 --procs THQ --massPoints 125 
