...
if [ $1 -eq 0 ]; then
  python /afs/cern.ch/work/p/prsaha/public/FinalFit_lite/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/fTest.py --cat THQLeptonicTag --procs THQ --ext Tprime700_2016 --inputWSDir /eos/user/p/prsaha/Tprime_analysis/FinalFit_inputs/v2/2016/M700 --nProcsToFTest -1 --doPlots
fi
