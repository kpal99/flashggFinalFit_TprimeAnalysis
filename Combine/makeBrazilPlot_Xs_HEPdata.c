...
void makeBrazilPlot_Xs_HEPdata(TString channel="", TString method="mu", TString ext=""){
gStyle->SetOptStat(0);
gROOT->SetBatch();
setTDRStyle();
const int points=10;
...
//cout<<"  - value: "<<xsBr[i]<<endl;
cout<<"  - value: "<<obsl[i]<<endl;
/*
cout<<"  - errors:"<<endl;
cout<<"    - asymerror:"<<endl;
cout<<"        minus: "<<-eyl[i]<<endl;
cout<<"        plus: "<<eyh[i]<<endl;
cout<<"      label: 68% CI"<<endl;
cout<<"    - asymerror:"<<endl;
cout<<"        minus: "<<ey2l[i]<<endl;
cout<<"        plus: "<<ey2h[i]<<endl;
cout<<"      label: 95% CI"<<endl;
cout<<"    value: "<<y[i]<<endl;
*/	
        }
//====================================================================================================
...
cout<<"  - errors:"<<endl;
cout<<"    - asymerror:"<<endl;
cout<<"        minus: "<<-eyl_[j]<<endl;
cout<<"        plus: "<<eyh_[j]<<endl;
cout<<"      label: 68% CI"<<endl;
cout<<"    - asymerror:"<<endl;
cout<<"        minus: "<<-ey2l_[j]<<endl;
cout<<"        plus: "<<ey2h_[j]<<endl;
cout<<"      label: 95% CI"<<endl;
cout<<"    value: "<<y[j]<<endl;
        }
...
//	n[j]=((kappaT[i]*kappaT[i])/(kT_NWA[j]*kT_NWA[j]))*T_xs_[j]*0.00227*1000;
	...
	n_pts++;
	if(kappaT[i]==0.25)cout<<"  - value: "<<n[j]<<endl;
	}
...
TLegend *leg1 = new TLegend(0.43, 0.72, 0.91, 0.88, "");
