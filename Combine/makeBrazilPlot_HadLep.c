...
void makeBrazilPlot_HadLep(TString channel="", TString method="mu", TString ext=""){
gStyle->SetOptStat(0);
gROOT->SetBatch();
setTDRStyle();
const int points=10;
...
tex1->DrawLatex(0.77, 0.23, "#scale[0.6]{#kappa_{T}=0.10}");
tex1->SetTextAngle(-12);
tex1->DrawLatex(0.77, 0.335, "#scale[0.6]{#kappa_{T}=0.15}");
tex1->DrawLatex(0.77, 0.41, "#scale[0.6]{#kappa_{T}=0.20}");
tex1->DrawLatex(0.77, 0.47, "#scale[0.6]{#kappa_{T}=0.25}");
*/
/*tex1->SetTextAngle(-17);
