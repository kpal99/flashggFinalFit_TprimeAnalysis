...
void makeBrazilPlot_FW_10(TString channel="", TString method="mu", TString ext=""){
gStyle->SetOptStat(0);
gROOT->SetBatch();
setTDRStyle();
const int points=10;
...
TString file_path="/afs/cern.ch/work/p/prsaha/public/FinalFit_lite/CMSSW_10_2_13/src/flashggFinalFit/Combine/result_UL_v2_FW_10/Models_Tprime";
...
leg1->AddEntry(Th_line,"#scale[1.1]{Theory}" ,"l");
