...
cd /afs/cern.ch/work/p/prsaha/public/FinalFit_lite/CMSSW_10_2_13/src/flashggFinalFit/Combine/runFits_HiggsCR_mu_inclusive

if [ $1 -eq 0 ]; then
  combine --floatOtherPOIs 1 -P r --algo grid --alignEdges 1 --saveSpecifiedNuis all --saveWorkspace --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 -M MultiDimFit -m 125 -d ../Datacard_HiggsCR_mu_inclusive.root --setParameterRanges r=0,2 --points 20 --firstPoint 0 --lastPoint 0 -n _profile1D_syst_obs_r.POINTS.0.0
fi
if [ $1 -eq 1 ]; then
