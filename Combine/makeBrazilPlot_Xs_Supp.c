...
void makeBrazilPlot_Xs_Supp(TString channel="", TString method="mu", TString ext="_Supp"){
gStyle->SetOptStat(0);
gROOT->SetBatch();
setTDRStyle();
const int points=10;
...
TLegend *leg1 = new TLegend(0.38, 0.7, 0.91, 0.88, "");
...
leg1->AddEntry(Th_kTVsXs_fkT2[2],"#scale[1]{Theory at fixed #kappa_{T}}" ,"l");
leg1->AddEntry(Th_WidthVsXs,"#scale[1]{Theory at fixed #Gamma/M_{T'}}" ,"l");
//leg1->AddEntry(Th_line,"#scale[1]{Theory at fixed #Gamma/M_{T'}=1\%}" ,"l");
...
//tex1->DrawLatex(0.3, 0.21, "#scale[0.6]{#kappa_{T}=0.05}");
	...
	tex1->DrawLatex(0.77, 0.225, "#scale[0.6]{#kappa_{T}=0.10}");
	tex1->SetTextAngle(-12);
	tex1->DrawLatex(0.77, 0.31, "#scale[0.6]{#kappa_{T}=0.15}");
	tex1->DrawLatex(0.77, 0.365, "#scale[0.6]{#kappa_{T}=0.20}");
	tex1->DrawLatex(0.77, 0.41, "#scale[0.6]{#kappa_{T}=0.25}");
}

else {
	tex1->SetTextAngle(-13);
	tex1->DrawLatex(0.77, 0.235, "#scale[0.6]{#kappa_{T}=0.10}");
	tex1->SetTextAngle(-12);
	tex1->DrawLatex(0.77, 0.34, "#scale[0.6]{#kappa_{T}=0.15}");
	tex1->DrawLatex(0.77, 0.415, "#scale[0.6]{#kappa_{T}=0.20}");
	tex1->DrawLatex(0.77, 0.47, "#scale[0.6]{#kappa_{T}=0.25}");
}

//tex1->SetTextColor(kBlue);
tex1->SetTextColor(kRed);
tex1->SetTextAngle(-19);
tex1->DrawLatex(0.4, 0.485, "#scale[0.6]{#Gamma/M_{T'}=1%}");
tex1->DrawLatex(0.4, 0.685, "#scale[0.6]{#Gamma/M_{T'}=5%}");
...
tex1->DrawLatex(0.2, 0.84, "#scale[0.8]{T' #rightarrow tH(H #rightarrow #gamma #gamma)}");
